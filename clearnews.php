        ...
        <header class="tech-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-col fixed-top bg-col">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="upload/kt_logo.jpeg" alt="" height="50" width="100"></a>
...
ಸುದ್ದಿ</a></li>
                                    ...
                                    <li class="breadcrumb-item active">ಅರ್ಜುನನಿಗೆ 60 ವರ್ಷ ತುಂಬಿದ ಹಿನ್ನೆಲೆಯಲ್ಲಿ ಈ ವರ್ಷದ ದಸರಾ ಅಂಬಾರಿ ಹೋರುವ ಭಾಗ್ಯ ಅಭಿಮನ್ಯುಗೆ ಒಲಿದಿದೆ.</li>
                                </ol>

                                <span class="color-orange"><a href="" title="">
ಕ್ರೀಡೆ</a></span>

                                <h3>ಅರ್ಜುನನಿಗೆ 60 ವರ್ಷ ತುಂಬಿದ ಹಿನ್ನೆಲೆಯಲ್ಲಿ ಈ ವರ್ಷದ ದಸರಾ ಅಂಬಾರಿ ಹೋರುವ ಭಾಗ್ಯ ಅಭಿಮನ್ಯುಗೆ ಒಲಿದಿದೆ.</h3>

                                <div class="blog-meta big-meta">
                                    <small><a href="#" title="">09 September, 2020</a></small>
                                    <small><a href="#" title="">by Santhosh</a></small>
                                    <small><a href="#" title=""><i class="fa fa-eye"></i> 236</a></small>
                                </div><!-- end meta -->
                            ...
                            <div class="single-post-media">
                                <img src="upload/amba2.jpeg" alt="" height="400" width="200" class="">
                            ...
                            <div class="blog-content">  
                                <div class="pp">
                                     ...
                                     <h3><strong>ನಾಡಹಬ್ಬ ಮೈಸೂರು ದಸರಾ                 </strong>        </h3>
                                     
                                    <p>ಸುಪ್ರೀಂಕೋರ್ಟ್​ ಆದೇಶದಂತೆ 60 ವರ್ಷ ತುಂಬಿದ ಆನೆಗಳಿಗೆ ಭಾರ ಹೊರಿಸುವಂತಿಲ್ಲ. ಆದ ಕಾರಣ ಸತತ 8 ವರ್ಷ ಯಶಸ್ವಿಯಾಗಿ ಅಂಬಾರಿ ಹೊತ್ತ ಅರ್ಜುನನಿಗೆ ಈ ವರ್ಷ 60 ವರ್ಷ ತುಂಬಿದ ಹಿನ್ನೆಲೆಯಲ್ಲಿ ಅಂಬಾರಿ ಹೊರಿಸಲಾಗುತ್ತಿಲ್ಲ.
</p>

                                   

                                    <p>ಕಾನೂನು ತಜ್ಞರ ಸಲಹೆ ಪಡೆದು ಶೀಘ್ರವೇ ಅರಣ್ಯ ಇಲಾಖೆ ಈ ಕುರಿತು ನಿರ್ಧಾರ ಮಾಡಲಿದೆ.

ಸದ್ಯ ಕೂಂಬಿಂಗ್​ ಸ್ಪೆಷಲಿಸ್ಟ್​ ಎಂದೇ ಹೆಗ್ಗಳಿಕೆ ಪಡೆದಿರುವ, ದಸರಾದಲ್ಲಿ ನೌಪತ್ ​ಆನೆಯಾಗಿ ಕಾರ್ಯ ನಿರ್ವಹಿಸುತ್ತಿರುವ ಅಭಿಮನ್ಯುಗೆ ಅಂಬಾರಿ ಹೊರುವ ಭಾಗ್ಯ ಸಿಕ್ಕಿದೆ.
</p>
<div class="single-post-media">
                                <img src="upload/amba1.jpeg" alt="" height="400" width="200" class="">
                                
                            </div><!-- end media -->

<p> ಎರಡನೇ ಪಂದ್ಯದಲ್ಲಿ ದೆಹಲಿ ಕ್ಯಾಪಿಟಲ್ಸ್ ಮತ್ತು ಕಿಂಗ್ಸ್ ಇಲೆವೆನ್ ಪಂಜಾಬ್ ಹಾಗೂ ಮೂರನೇ ಪಂದ್ಯದಲ್ಲಿ ರಾಯಲ್ ಚಾಲೆಂಜರ್ಸ್ ಬೆಂಗಳೂರು ಮತ್ತು ಹೈದರಾಬಾದ್ ತಂಡಗಳು ಗೆಲುವಿಗಾಗಿ ಹೋರಾಟ ನಡೆಸಲಿವೆ.
...
<p>
                                ...
                                <img src="amba1.jpeg" alt="" class="img-fluid img-fullwidth">
