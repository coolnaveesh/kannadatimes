             ...
             <section class="section first-section">
                    ...
                    <div class="first-slot">
                        <div class="masonry-box post-media">
                             <img src="upload/pic.jpeg" alt="" height="350" width="300" class="">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="" title="">ಸಿನಿಮ</a></span>
                                        <h4><a href="tech-single.html" title="">ಸಿನಿ ರಸಿಕರಿಗೆ ಸಿಹಿ ಸುದ್ದಿ... </a></h4>
                                        <small><a href="tech-single.html" title="">09 Sep, 2020</a></small>
                                        <small><a href="tech-author.html" title="">by Ananda</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end shadow-desc -->
                            </div><!-- end shadow -->
                        </div><!-- end post-media -->
