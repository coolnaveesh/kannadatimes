...
<html lang="en">
   ...
   <link rel="shortcut icon" href="images/logon.jpeg" type="image/x-icon"/>
    ...
    <link href="css/font-awesome.min.css" rel="stylesheet">t
...
<body>
                   ...
                   <a class="navbar-brand" href="index.html"><img src="upload/kt_logo.jpeg" alt="" height="50" width="100"></a>
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                         <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="index.php">ಸುದ್ದಿ</a>

                            </li>
                            <li class="nav-item dropdown has-submenu menu-large hidden-md-down hidden-sm-down hidden-xs-down">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ಟ್ರೆಂಡಿಂಗ್</a>
                                <ul class="dropdown-menu megamenu" aria-labelledby="dropdown01">
                                    <li>
                                        <div class="container">
                                            <div class="mega-menu-content clearfix">
                                                <div class="tab">
                                                    <button class="tablinks active" onclick="openCategory(event, 'cat01')">ಕರೋನಾ</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat02')">ತಂತ್ರಜ್ಞಾನ</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat03')">ಸಾಮಾಜಿಕ ಮಾಧ್ಯಮ</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat04')">ವಿಜ್ಞಾನ</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat05')">ವಿಶ್ವಾದ್ಯಂತ</button>
                                                </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="health.php">ಆರೋಗ್ಯ</a>
                            </li> 
                            <li class="nav-item">
                                <a class="nav-link" href="bengaluru.php">ನಮ್ಮ ನಗರ ಬೆಂಗಳೂರು</a>
                            </li>
                             <li class="nav-item">
                                <a class="nav-link" href="#">ಹೆಮ್ಮೆಯ ಕನ್ನಡಿಗರು</a>
                            </li>
                             
                             <li class="nav-item dropdown has-submenu menu-large hidden-md-down hidden-sm-down hidden-xs-down">
                                <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ಕ್ರೀಡೆ </a>
                                <ul class="dropdown-menu megamenu" aria-labelledby="dropdown01">
                                    <li>
                                        <div class="container">
                                            <div class="mega-menu-content clearfix">
                                                <div class="tab">
                                                    <button class="tablinks active" onclick="openCategory(event, 'cat01')">ಕ್ರಿಕೆಟ್</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat02')">ಹಾಕಿ</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat03')">ಫುಟ್ಬಾಲ್</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat04')">ಬ್ಯಾಡ್ಮಿಂಟನ್</button>
                                                    <button class="tablinks" onclick="openCategory(event, 'cat05')">ಐಪಿಎಲ್</button>
                                                </div>
                             ...
                             <li class="nav-item">
                                <a class="nav-link" href="#">ಸಿನಿಮಾ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#">ಅಂಕಣ</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link" href="#">ವೀಡಿಯೊ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#">ಪುಟಾಣಿ ಪ್ರಪಂಚ</a>
                            </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-play bg-orange"></i> ಕನ್ನಡ ಟೈಮ್ಸ್ ನ್ಯೂಸ್ ಗೆ  ಶುಭಕೋರುವವರು್  </h2>
                    </div><!-- end col -->
        ...
        <section class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="container" style="background-color: white; border-radius: 10px; opacity: 0.8;"><br>
	<h2 style="text-align: center; color: orangered;"><b><u></u></b></h2><br><br>
	<style>
		#read{
			border: none;
	...
	<div class="row" style="text-align: center;">
		<div class="col-sm-3">
		  ...
		  <video width="320" height="240" controls>
                                           <source src="videos/1st_video.mp4" type="video/mp4">
 ...
 <video width="320" height="240" controls>
                                           <source src="videos/2_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
...
<p style="font-family: sans-serif; color: black;">
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/3_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/4_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/5_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/6_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/7_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/8_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/9_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/10_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		...
		<div class="col-sm-3">
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/11_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/12_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/13_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/14_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/15_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/16_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		  ...
		  <video width="320" height="240" controls>
                                           <source src="videos/18_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/19_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
		 ...
		 <video width="320" height="240" controls>
                                           <source src="videos/20_video.mp4" type="video/mp4">
                                           <source src="movie.ogg" type="video/ogg">
                                           Your browser does not support the video tag.
                                           </video>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <br>
                        <div class="copyright">&copy; PublicTimes. Design: <a href="http://html.design">HTML Design</a>.</div>
                    </div>
                </div>
            </div><!-- end container -->
        </footer><!-- end footer -->
