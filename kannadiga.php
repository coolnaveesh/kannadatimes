...
ಆರೋಗ್ಯ</a>
        ...
        <section class="section">
            ...
            <?php } }?>
            <ul class="img-fluid" data-clearing>
               <?php
               require 'dbc.php';
               $stmt = $dbc->query("SELECT * FROM news ORDER by id ASC");
               foreach ($stmt as $img) {
               ?>
           
                  <a href="tech-single.html" title="">
                      <div class="img-fluid">
                  <img data-caption="<?= $img['img_title']; ?>" src="adminkt/newsuploads/<?= $img['name'];?>" height="200" width="200" >
                  </a>
               </div>    </div>
                   ...
                   <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="tech-single.html" title=""></a><?=$img['heading'];?></h4>
                                        <p><?=$img['content'];?></p>
                                        <small class="firstsmall"><a class="bg-orange" href="tech-category-01.html" title="">Reviews</a></small>
                                        <small><a href="tech-single.html" title=""></a><?=$img['date'];?></small>
                                        <small><a href="tech-author.html" title=""></a><?=$img['author'];?></small>
